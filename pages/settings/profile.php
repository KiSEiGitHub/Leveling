    ...
    <div class="setting-container">
        ...
        <div class="setting-container-content">
            ...
            <div class="display-info">
                <h4>Bio :&ensp;</h4>
                <h4><?= $user->UQ_Users_Bio ?></h4>
            </div>
            <div class="display-info">
                <h4>Plateforme :&ensp;</h4>
                <h4><?= $user->UQ_AboutUsers_Plateforme ?></h4>
            </div>
            <div class="display-info">
                <h4>Discord :&ensp;</h4>
                <h4><?= $user->UQ_UserPreferences_Discord ?></h4>
            </div>
            <div class="display-info">
                <h4>Twitch :&ensp;</h4>
                <h4><?= $user->UQ_UserPreferences_Twitch ?></h4>
            </div>
            <div class="display-info">
                <h4>Steam :&ensp;</h4>
                <h4><?= $user->UQ_UserPreferences_Steam ?></h4>
            </div>
            <div class="display-info">
                <h4>Pseudo :&ensp;</h4>
                <h4><?= $user->UQ_Users_Pseudo ?></h4>
            </div>
            <div class="display-info">
                <h4>Jeu favori :&ensp;</h4>
                <h4><?= $user->UQ_AboutUsers_JeuFav ?></h4>
            </div>
            <div class="display-info">
                <h4>Genre favori :&ensp;</h4>
                <h4><?= $user->UQ_AboutUsers_GenreFav ?></h4>
            </div>
            <div class="display-info">
            ...
            <a href="updateProfile.php" class="bold grey" style="margin-top: 20px; display: block">Modifier vos informations</a>
        </div>
    </div>
</main>
