...
<body>
    ...
    <h1 class="welcome-user">BIENVENUE <span>@USERNAME</span> !</h1>
         ...
         <div id="myCarousel" class="carousel slide" data-ride="carousel" outline="none">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="six-img">
                    <a href=""><img class="d-block" src="../../assets/img/insert_games/pp/IMG-6277a0b2c5b848.96970598.png" width="50px"></a>
                    <a href=""><img class="d-block" src="../../assets/img/insert_games/pp/IMG-6277c1dd81fac1.30807447.png" width="50px"></a>
                    <a href=""><img class="d-block" src="../../assets/img/insert_games/pp/IMG-6277c4d6a07249.43984088.png" width="50px"></a>
                    <a href=""><img class="d-block" src="../../assets/img/insert_games/pp/IMG-6277c6a22b28e2.44535644.jpg" width="50px"></a>
                    <a href=""><img class="d-block" src="../../assets/img/insert_games/pp/IMG-6277c834d664b1.00746124.jpg" width="50px"></a>
                    <a href=""><img class="d-block" src="../../assets/img/insert_games/pp/IMG-6277cbba06bf30.27950667.jpg" width="50px"></a>
                    </div>
                </div>
  ...
  <a class="carousel-control-next" href="#myCarousel" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
      ...
      <!--Carousel FIN-->
        ...
        <p><span>GAME</span> Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla quos ullam corrupti et eos exercitationem aliquam, debitis quas harum ipsum provident architecto reiciendis ducimus laudantium eaque voluptate quod recusandae veniam.</p>
        </div>
        </div>
        ...
        <p>[INSERER ICI LA BIO DU GROUPE EN QUESTION] Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum ipsum provident architecto reiciendis ducimus laudantium eaque voluptate quod recusandae veniam.</p>
        </div>
        </div>
